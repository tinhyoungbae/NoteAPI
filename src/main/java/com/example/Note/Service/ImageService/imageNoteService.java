...
public class imageNoteService implements interfaceImageNoteService{
    ...
    @Override
    public ResponseEntity<Response> addImageNote(imageNote imageNote, String imageNoteName, MultipartFile imageNotePath, String imageNoteSize, Timestamp imageNoteCreatedDate) {
